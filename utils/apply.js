...
module.exports = {
    apply: async function(user, videoLink) {
		...
		.addFields(
			...
			{ name: 'Should have applied like this', value: '1. Click Apply Button\n2. Upload a Minecraft video (5 seconds to 1 minute) to YouTube, including a scene where the recording starts and stops.\n3. Paste the vide\'s link here. (Only link works!)' },
		)
		.setTimestamp()
